...
- **Document-Centric Workflow (0):** Upload a contract document (.docx or .pdf) at **Step 0 (Tiering)** to establish an active contract context. The app instantly auto-scores the contract across four axes — Value, Risk, Criticality, Business Impact — and recommends a management tier, with support for standard or Gold/Silver/Bronze schemes.
