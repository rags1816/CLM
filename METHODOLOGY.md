...
- **Inputs:** manual contract scoring, or Word/PDF contract text uploaded at Step 0 (supports multiple files, up to 350 pages per document, with text stored up to 1,200,000 characters); maturity questionnaire responses
